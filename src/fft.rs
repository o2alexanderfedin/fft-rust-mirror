...
extern "C" fn next_reversed_n(mut reversed_n: u64, shift: u64) -> u64 {
    reversed_n <<= shift;
    let count_leading_ones: u64 = unsafe { __builtin_clzl(!reversed_n) } as u64;
...
#[inline]
#[allow(unused_doc_comments)]
extern "C" fn rader(array: *const FftComplexT, target: *mut FftComplexT, logsize: u64) -> () {
    let size: u64 = (1 as u64) << logsize;
    /// how many bits should be shift to move the number to the most significant bit
    let shift: u64 = (core::mem::size_of::<u64>() as u64)
        .wrapping_mul(8 as u64)
        .wrapping_sub(logsize);
    {
        ...
        '__b0: loop {
            ...
            '__c0: loop {
                '__b1: loop {
                    '__c1: loop {
                        unsafe {
                            *target.add(reversed_n as usize) = unsafe { *array.add(n as usize) }
                        };
                        break '__c1;
                    }
                    if !(0 != 0) {
...
extern "C" fn fft_raw(x: *mut FftComplexT, logsize: u64) -> () {
    if (!(logsize == 0 as u64) as i32 == 0) as i32 as i64 != 0 {
        return;
    }
        ...
        '__c2: loop {
            ...
            '__b3: loop {
                '__c3: loop {
                    ...
                    unit.imag = -unsafe { sin(2 as f64 * 3.141592653589793 / 2 as f64) } as f32;
                    break '__c3;
                }
                if !(0 != 0) {
                    break '__b3;
                            ...
                            '__b14: loop {
                                ...
                                '__c14: loop {
                                    '__b15: loop {
                                        '__c15: loop {
                                            let r: f32 =
                                                root.real * unit.real - root.imag * unit.imag;
                                            let mut i: f32 =
                                    ...
                                    '__b16: loop {
                                        '__c16: loop {
                                            t.real = root.real
                                                * unsafe { (*p.add(j as usize)).real }
                                                - root.imag * unsafe { (*p.add(j as usize)).imag };
                                            t.imag = root.real
                                                * unsafe { (*p.add(j as usize)).imag }
    ...
    if (!(logsize == 1 as u64) as i32 == 0) as i32 as i64 != 0 {
        return;
    }
    '__b20: loop {
        '__c20: loop {
            ...
            '__b21: loop {
                '__c21: loop {
                    ...
                    unit.imag = -unsafe { sin(2 as f64 * 3.141592653589793 / 4 as f64) } as f32;
                    break '__c21;
                }
                if !(0 != 0) {
                    break '__b21;
    ...
    if (!(logsize == 2 as u64) as i32 == 0) as i32 as i64 != 0 {
        return;
    }
    {
        let mut step: u64 = 8 as u64;
        '__b38: loop {
            if !(step <= (1 as u64) << logsize) {
                break '__b38;
            }
            '__c38: loop {
                '__b39: loop {
                            ...
                            '__b41: loop {
                                ...
                                '__c41: loop {
                                    ...
                                    '__b44: loop {
                                        '__c44: loop {
                                            unsafe {
                                                (*p.offset(0 as isize)).real = u.real + t.real
                                            };
                                            unsafe {
                                                (*p.offset(0 as isize)).imag = u.imag + t.imag
                                            };
                                            break '__c44;
                                        }
                                        if !(0 != 0) {
                                    ...
                                    '__b45: loop {
                                        '__c45: loop {
                                            unsafe {
                                                (*p.add(half as usize)).real = u.real - t.real
                                            };
                                            unsafe {
                                                (*p.add(half as usize)).imag = u.imag - t.imag
                                            };
                                            break '__c45;
                                        }
                                        if !(0 != 0) {
                                    ...
                                    '__b47: loop {
                                        '__c47: loop {
                                            t.real = root.real
                                                * unsafe {
                                                    (*p.add(half.wrapping_add(1 as u64) as usize))
                                                        .real
                                                }
                                                - root.imag
                                                    * unsafe {
                                                        (*p.add(
                                                            half.wrapping_add(1 as u64) as usize
                                                        ))
                                                        .imag
                                                    };
                                            t.imag = root.real
                                    ...
                                    '__b49: loop {
                                        '__c49: loop {
                                            unsafe {
                                                (*p.offset(1 as isize)).real = u.real + t.real
                                            };
                                            unsafe {
                                                (*p.offset(1 as isize)).imag = u.imag + t.imag
                                            };
                                            break '__c49;
                                        }
                                        if !(0 != 0) {
                                    ...
                                    }
                                    {
                                        ...
                                        '__b51: loop {
                                            ...
                                            '__c51: loop {
                                                '__b52: loop {
                                                    '__c52: loop {
                                                        let r: f32 = root.real * unit.real
                                                            - root.imag * unit.imag;
                                                        let mut i: f32 = root.real * unit.imag
                                                            + root.imag * unit.real;
                                                        root.real = r;
                                                        root.imag = i;
                                                        break '__c52;
                                                    ...
                                                    '__c53: loop {
                                                        t.real = root.real
                                                            * unsafe { (*p.add(j as usize)).real }
                                                            - root.imag
                                                                * unsafe {
                                                                    (*p.add(j as usize)).imag
                                                                };
                                                        t.imag = root.real
                                                            * unsafe { (*p.add(j as usize)).imag }
                                                            + root.imag
                                                                * unsafe {
                                                                    (*p.add(j as usize)).real
                                                                };
                                                        break '__c53;
                                                    }
                                                    if !(0 != 0) {
                                                ...
                                                '__b55: loop {
                                                    '__c55: loop {
                                                        unsafe {
                                                            (*p.add(i as usize)).real =
                                                                u.real + t.real
                                                        };
                                                        unsafe {
                                                            (*p.add(i as usize)).imag =
                                                                u.imag + t.imag
                                                        };
                                                        break '__c55;
                                                    }
...
pub(crate) extern "C" fn fft(x: *const FftComplexT, x_1: *mut FftComplexT, logsize: u64) -> () {
    rader(x, x_1, logsize);
    fft_raw(x_1, logsize);
}
...
extern "C" fn rader_inplace(array: *mut FftComplexT, logsize: u64) -> () {
        ...
        .wrapping_sub(logsize);
    {
        ...
        '__b57: loop {
            if !(n < size.wrapping_sub(1 as u64)) {
                break '__b57;
            }
            '__c57: loop {
                if n < reversed_n {
                    '__b58: loop {
                        '__c58: loop {
                            ...
                            unsafe {
                                *array.add(n as usize) = unsafe { *array.add(reversed_n as usize) }
                            };
